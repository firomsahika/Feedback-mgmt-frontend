...
import { LayoutDashboard , BookOpen , FileText, SlidersHorizontal ,Bell, Inbox, User, MessageCircle, Send  } from "lucide-react";
...
const studentItems = [
  ...
  { title: "Submit Feedback", url: "/dashboard/student/submit-feedback", icon: Send },
  { title: "View My Feedback", url: "/dashboard/student/view-feedback", icon: MessageCircle },
...
export function SideBar() {
  ...
  return (
    <aside className="h-full w-64 bg-teal-600 border-r shadow-sm ">
